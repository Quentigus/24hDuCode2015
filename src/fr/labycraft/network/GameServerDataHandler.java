 ...
 */
public class GameServerDataHandler {
    private static final Logger logger = Logger.getLogger(GameServerDataHandler.class.getName());
    ...
    public GameServerDataHandler(final int width, final int height, final int gridSize, final DataGenerator generator, final File mapFile) {
        this.width = width;
        this.height = height;
