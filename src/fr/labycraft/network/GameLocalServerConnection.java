 ...
 * etc to your server.
 */
public class GameLocalServerConnection implements IServerConnection {
    private final GameServerDataHandler server;
    private ChunkModifier chunkModifier;

    public GameLocalServerConnection(final GameServerDataHandler server) {
        this.server = server;
